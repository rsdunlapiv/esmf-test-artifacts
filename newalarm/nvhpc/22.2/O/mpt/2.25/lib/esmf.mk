...
ESMF_APPSDIR=/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/apps/appsO/Linux.nvhpc.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/src/include  -I/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/include -I/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b13-21-g29f31e7579' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -mcmodel=small -pthread -Wl,--no-as-needed  -mp
ESMF_CXXLINKPATHS=-L/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib 
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf/lib/libO/Linux.nvhpc.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf
ESMF_INTERNAL_MPIRUN=mpirun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/dunlap/esmf-test-dev/nvhpc_22.2_mpt_O_newalarm/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: nvhpc
