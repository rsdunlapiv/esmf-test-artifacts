#!/bin/sh -l
#SBATCH --account=e3sm
#SBATCH -o /global/cscratch1/sd/rsdunlap/esmf-test-dev/intel_19.1.2_mpiuni_O_develop/test.bat_%j.o
#SBATCH -e /global/cscratch1/sd/rsdunlap/esmf-test-dev/intel_19.1.2_mpiuni_O_develop/test.bat_%j.e
#SBATCH --time=3:00:00
#SBATCH -C haswell
#SBATCH --qos=regular
#SBATCH --nodes=1
...
module list >& /global/cscratch1/sd/rsdunlap/esmf-test-dev/intel_19.1.2_mpiuni_O_develop/module-test.log
