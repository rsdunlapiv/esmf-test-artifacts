...
ESMF_APPSDIR=/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/apps/appsg/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/mod/modg/Linux.pgi.64.mpiuni.default -I/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/src/include -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.4.0b04-2-gc831a7cd4a' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=1 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE
...
ESMF_F90LINKPATHS=-L/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_F90ESMFLINKPATHS=-L/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/src/include  -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include -I/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/src/Infrastructure/stubs/mpiuni -I/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.4.0b04-2-gc831a7cd4a' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=1 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -lpthread -Wl,--no-as-needed
ESMF_CXXLINKPATHS=-L/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_CXXESMFLINKPATHS=-L/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/lib/libg/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf
ESMF_INTERNAL_MPIRUN="/scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf/src/Infrastructure/stubs/mpiuni/mpirun"

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/cluster/dunlap/esmf-test-dev/pgi_20.1_mpiuni_g_develop/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: pgi
